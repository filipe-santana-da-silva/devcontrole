...
export function FormTicket({ customer}: FormTicketProps){
    ...
    async function handleRegisterTickets(data: FormData){
    ...
    return(
        <form className="bg-slate-50 mt-6 px-4 py-6 rounded border-2" onSubmit={handleSubmit(handleRegisterTickets)}>
